...
def tf2onnx_from_graph_def(
    tf_graph_def, inputs, params, output_tensor_names, opset=None, is_export_onnx=False, output_path=None,
):
    """
    @param:
    ...
    if is_export_onnx:
        fill_random_weights_to_onnx_model(onnx_model_def, "random.onnx" if output_path is None else output_path, params)
...
def miotf_to_onnxb64(
    mio_graph_def, inputs, params, output_tensor_names, opset=None, is_export_onnx=False, output_path=None,
):
    """
